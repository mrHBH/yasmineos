...
exports.WorldClient = exports.WorldNetworkClient = exports.WorldAIClient = void 0;
...
class WorldAIClient extends WorldClient {
    ...
    OnUpdate_(timeElapsed) {
        if (this.isMobile) {
            const movement = gl_matrix_1.vec3.fromValues(0.0, 0, this.direction * 0.5);
            gl_matrix_1.vec3.scale(movement, movement, timeElapsed * 10.0);
            gl_matrix_1.vec3.add(this.entity_.position_, this.entity_.position_, movement);
            this.entity_.UpdateGridClient_();
            this.entity_.state_ = "Running";
        }
    }
}
exports.WorldAIClient = WorldAIClient;
...
exports.WorldNetworkClient = WorldNetworkClient;
