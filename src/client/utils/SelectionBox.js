...
class SelectionBox {
	...
	searchChildInFrustum( frustum, object ) {
		...
		// if (object.type === 'Group' && object.userData.EntityGroup !== undefined) {
		// 	//Get Entity position
		// 	const position = object.userData.EntityGroup.Position;
		// 	 if ( frustum.containsPoint(position.clone().add(new Vector3(0,1,0))) ) {
		// 			this.collection.push( object.userData.EntityGroup );
		// 	 }
...
// 		}
		...
		if ( object.children.length > 0  && object.userData.EntityGroup === undefined ) {
